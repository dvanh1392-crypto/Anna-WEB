const translations = {
  vi: {
    ...
    metaDescription:
      "Trang giới thiệu quán bia, quán nhậu ở thành phố Vĩnh Yên, Vĩnh Phúc với thông tin địa chỉ, đánh giá, ảnh quán và tính khoảng cách từ vị trí của bạn.",
    ...
    introText:
      "Trang được thiết kế theo kiểu danh sách nổi bật, ưu tiên trải nghiệm nhanh: tìm kiếm theo tên quán, lọc theo loại món, xem ảnh thực tế và sắp xếp theo đánh giá hoặc khoảng cách sau khi người dùng cho phép chia sẻ vị trí.",
    ...
    highlightPopularText: "{reviews} lượt review, phù hợp để tham khảo trước khi đi.",
    highlightNearText: "Khoảng cách ước tính {distance} từ vị trí hiện tại của bạn.",
    highlightQuickText: "Bật định vị để xem quán gần bạn nhất trong danh sách.",
    resultLoaded: "Hiển thị {count} quán trong dữ liệu mẫu của website.",
    resultEmpty: "Không tìm thấy quán phù hợp với bộ lọc hiện tại.",
    emptyHint: "Thử đổi từ khóa tìm kiếm hoặc chọn lại loại quán để xem thêm địa điểm.",
  ...
  en: {
    ...
    featureList: [
      "A curated list of venues in Vinh Yen",
      "Address, phone number and opening hours",
      "Reference ratings and review counts",
      "Venue photos and menu images when publicly available",
      "Distance from the current location to each place",
    ],
    ...
    highlightBestText: "{rating} stars from {reviews} reference reviews.",
    highlightPopularText: "{reviews} reviews, useful for checking before you go.",
    highlightNearText: "Estimated distance: {distance} from your current location.",
    highlightQuickText: "Turn on location to see the closest venue in the list.",
    resultLoaded: "Showing {count} venues from the website sample data.",
    resultEmpty: "No venues match the current filters.",
    emptyHint: "Try another keyword or change the selected venue type.",
  ...
  zh: {
    ...
    highlightNear: "离你最近",
    highlightQuick: "快速推荐",
    highlightBestText: "{reviews} 条参考评论，评分 {rating} 星。",
    highlightPopularText: "共有 {reviews} 条评论，出门前可先参考。",
    highlightNearText: "距离你当前位置约 {distance}。",
    highlightQuickText: "开启定位后即可查看离你最近的店铺。",
    resultLoaded: "当前显示网站示例数据中的 {count} 家店铺。",
    resultEmpty: "当前筛选条件下没有找到合适的店铺。",
    emptyHint: "请尝试更换关键词，或重新选择店铺类型。",
...
function renderLoadingState() {
  ...
  resultText.textContent = t("dataLoading");
  venueGrid.innerHTML = "";
}
...
function renderDataError() {
  venueCount.textContent = "0";
  highlightGrid.innerHTML = "";
  resultText.textContent = t("dataLoadError");
  venueGrid.innerHTML = "";
